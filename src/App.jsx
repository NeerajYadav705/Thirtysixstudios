...
function App() {
  ...
  const handleMouseMove = (e) => {
    const h1Element = e.target;
    const x = e.clientX - h1Element.offsetLeft - 0; // Adjusted for centering
    const y = e.clientY - h1Element.offsetTop - 200; // Adjusted for centering
  
    h1Element.style.setProperty('--mouse-x', `${x}px`);
    h1Element.style.setProperty('--mouse-y', `${y}px`);
  };
  ...
  return (
    <>
      ...
      <div className="w-full relative min-h-screen font-['Helvetica_Now_Display']">
        ...
        <div className="w-full relative z-[1] h-screen ">
          ...
          <div className="w-full absolute bottom-0 left-0">
            <h1
              ref={headingref}
              className="text-[12rem] font-normal tracking-tight leading-none pl-5 hover-effect"
      ...
      <div className="w-full relative h-screen  mt-32 px-10">
        ...
        <h2 className="text-6xl tracking-tighter">About the brand</h2>
